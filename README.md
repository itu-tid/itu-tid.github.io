...
| **5** · Sep 24 | [Authentication & Authorization in Parse](Lectures/Technical/Backend/Authorization-and-ACL-in-Parse.md) (ToDo26) | Add signup and login to your own app; |
