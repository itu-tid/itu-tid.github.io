...
**Which week does what is in the [syllabus](https://itu-tid.github.io/)**, and only there. Each week's card names the notes it uses, the **solo exercise** for that week's first hour, and the **project work** for the second — so if you miss an exercise session, that card is what you were going to be told.
