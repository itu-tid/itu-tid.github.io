...
```
- See: [T6-Updating Objects and Lists in State](Technical%20ID/Updating-Objects-and-Lists-in-State.md)


# The need for useRef
- i need to track the timer reference to clear it up when component is unmounted
- See: [T7-React-the-useRef-Hook](Technical%20ID/The-useRef-Hook.md)
