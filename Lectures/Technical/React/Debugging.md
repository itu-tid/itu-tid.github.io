...
Three tools, in the order you will reach for them: a `debugger;` statement, the React DevTools component tree, and a proper breakpoint in your editor. Then a word on reading the error before you touch anything.
...
[React Developer Tools](https://react.dev/learn/react-developer-tools) is a browser extension — install it once, for Chrome, Firefox or Edge, and it adds two panels that plain DevTools does not have:
